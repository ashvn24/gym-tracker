    ...
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 sm:p-8 shadow-lg border border-gray-100 dark:border-gray-700 transition-colors duration-300">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
          <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-blue-100 to-indigo-200 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-2xl flex items-center justify-center flex-shrink-0">
            {mg.imageUrl ? (
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2">{mg.name}</h1>
            <p className="text-gray-600 dark:text-gray-300 text-lg">Manage your {mg.name.toLowerCase()} workouts</p>
          </div>
        </div>
      </div>
